...
class SpineNeuralNet():
    def __init__(self):
        self.model_weights = 'HOUSE_spine_weights.h5'
    ...
    def train_neural_network(self):
        ...
        train_data_dir = 'brainImages\Spine'
        validation_data_dir = 'brainImages\Spine' 
        epochs = 50
        batch_size = 20
...
#==============================================================================
    ...
    def test_neural_network(self):
        ...
        for i in range(0, filenames):
            train_generator.filenames[i] = 'brainImages\Spine\\'+ train_generator.filenames[i]
            print(train_generator.filenames[i])
            if("Herniated" in train_generator.filenames[i]):
                trueY.append(0)
            if("Normal" in train_generator.filenames[i]):
                trueY.append(1)
