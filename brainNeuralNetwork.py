...
class BrainNeuralNet():
    def __init__(self):
        self.model_weights = 'HOUSE_brain_weights.h5'
    ...
    def train_neural_network(self):
        ...
        train_data_dir = 'brainImages\Brain'
        validation_data_dir = 'brainImages\Brain' 
        epochs = 50
        batch_size = 20
...
#==============================================================================
    ...
    def predict_neural_network(self, img):
        #input path
    ...
    def test_neural_network(self):
        ...
        for i in range(0, filenames):
            train_generator.filenames[i] = 'brainImages\Brain\\'+ train_generator.filenames[i]
            #print(train_generator.filenames[i])

            if("Back" in train_generator.filenames[i]):
                trueY.append(0)
            if("Side" in train_generator.filenames[i]):
                trueY.append(1)
            if("Top" in train_generator.filenames[i]):
                trueY.append(2)
        ...
        accuracy = confusion_matrix(predY, trueY,labels=[0, 1,2, 3, 4])
