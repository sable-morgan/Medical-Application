...
class ImagingNeuralNet():
    def __init__(self):
        self.model_weights = 'HOUSE_imaging_weights.h5'
        #self.model2_weights = 'HOUSE_brain_weights.h5'
    ...
    def train_neural_network(self):
        ...
        train_data_dir = 'brainImages'
        validation_data_dir = 'brainImages' 
        epochs = 50
        batch_size = 10
...
#==============================================================================
    ...
    def test_neural_network(self):
        ...
        for i in range(0, filenames):
            train_generator.filenames[i] = 'brainImages\\'+ train_generator.filenames[i]
            print(train_generator.filenames[i])
            if("Brain" in train_generator.filenames[i]):
                trueY.append(0)
            if("Spine" in train_generator.filenames[i]):
                trueY.append(1)
        for i in range(0, filenames):
